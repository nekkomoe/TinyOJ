...
function func_judge($problem_id, $content) {
	...
	echo "cd judge && ./judge $cppName $dataCount $inpath $inputName $outputName $outpath $stdOutputName $time";
	echo "<br/>";
	echo passthru("cd judge && ./judge $cppName $dataCount $inpath $inputName $outputName $outpath $stdOutputName $time");
}
